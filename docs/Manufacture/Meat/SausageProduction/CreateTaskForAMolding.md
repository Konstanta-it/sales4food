# Создание производственного задания на формовку колбасной продукции

Для создания производственного задания на формовку колбасной продукции в системе создаются документы **"Производственное задание"**.

- В подсистеме **"Производство"** открываем **"Производственные задания"**:

![](CreateTaskForAMolding.assets/1.png)

- Нажимаем на кнопку **"Создать"**:

![](CreateTaskForAMolding.assets/2.png)

Заполняем сведения на вкладке **"Основное"**:

1. Дата смены;
2. Смена;
3. Рабочий центр, на котором будет производиться формовка;
...
![](CreateTaskForAMolding.assets/4.png)