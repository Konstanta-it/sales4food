...
- Вести учет по товарам организации (доступно, если ведется учет по товарам организации)  
...
- Использовать прогнозный регистр (оперативный учет остатков не ведется по складу, а загружается в регистр Прогнозные остатки производства)  
- Управление двором  
- Отслеживать товары в пути (включается отслеживание отгрузки и приемки по заказам на пермещение на этот склад)  
