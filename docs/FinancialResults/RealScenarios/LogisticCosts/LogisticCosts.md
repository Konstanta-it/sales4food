...
Чтобы напрямую указывать стоимость доставки в документе Задание на доставку нужно перейти в "Настройки финансового результата" в разделе "Деньги" и включить настройку "Учет затрат на доставку в Задании на доставку"  
