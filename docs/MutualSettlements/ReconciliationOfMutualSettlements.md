...
На вкладке ***Взаиморасчеты*** заполняется табличная часть, содержащая информацию о взаиморасчетах по нашим данным и по данным контрагента. Заполняется по кнопке **Заполнить за период**.
