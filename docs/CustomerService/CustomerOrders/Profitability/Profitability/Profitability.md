...
В документе "Заказ клиента" на вкладке "Товары", нажав на иконку "Глазик", можно увидеть результаты плановой эффективности по каждой строке, в правом нижнем углу - общие результаты по заказу
...
Показатели расчета Стоимость и Пропорционально выручке берутся без / с НДС из табличной части заказа в зависимости от настройки ["Условия начисления ретро-бонусов"](../RetroBonus/RetroBonus.md) для соответствующей статьи планового расхода. Во всех остальных случаях берется сумма с НДС
