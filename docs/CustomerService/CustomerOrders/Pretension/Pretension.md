...
- Тип претензии - Претензия клиента;    
...
Для претензии клиента доступны следующие виды корректирующего действия:  
...
- Корректировка по соглашению сторон. При нажатии на кнопку Оформлено создается документ Корректировка реализации товаров с видом Корректировка по соглашению сторон. Создание корректировки только для претензии, у которой заполнено Основание на вкладке Основное.  
- Корректировка с исправлением ошибок. При нажатии на кнопку Оформлено создается документ Корректировка реализации товаров с видом Исправление ошибок. Создание корректировки только для претензии, у которой заполнено Основание на вкладке Основное. 
...
!!! attention ""  Оформление корректирующего действия доступно только для документа в статусе Утверждена. Данные по количеству и стоимости для корректировки берутся в зависимости от результата согласовании по строкам. Для Строк в статусе Не согласовано данные берутся из В документе, для Согласовано - Факт.  