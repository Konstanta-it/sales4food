...
- Корректировка первичной накладной. При нажатии на кнопку Оформить согласованные изменения передаются в документ-основание. Корректировка первичной накладной доступна только для претензии, у которой заполнено Основание на вкладке Основное.  
- Корректировка по соглашению сторон. При нажатии на кнопку Оформить создается документ Корректировка реализации товаров с видом Корректировка по соглашению сторон. Создание корректировки только для претензии, у которой заполнено Основание на вкладке Основное.  
- Корректировка с исправлением ошибок. При нажатии на кнопку Оформить создается документ Корректировка реализации товаров с видом Исправление ошибок. Создание корректировки только для претензии, у которой заполнено Основание на вкладке Основное.  
- Возврат товаров. При нажатии на кнопку Оформить создаются документы Заявка на возврат товаров, если есть признак Требуется доставка, и Возврат товаров от клиента, если признака нет.  
