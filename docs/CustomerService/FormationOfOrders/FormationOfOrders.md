...
**"Контроль остатков заказов"** не позволяет после оформления по заказу [плана отгрузки](../FormationOfShipments/PlanningOfShipments/CreationOfPlansForShipment.md) сделать количество товаров в заказе клиента меньше чем в плане. При этом количество в плане отгрузки нельзя сделать больше чем в заказе.  
...
- Заказ комиссионера;    
- [Заказ на перемещение](../../../Warehouse/MovingProducts/TransferOrder.md);  
- Внутренний заказ.  
...
!!! attention ""  На данной вкладке заполняется информация для создания бланков заказов клиента и заказов комиссионера.
