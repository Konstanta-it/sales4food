...
Для создания заявки на возврат товаров от комиссионера используется документ «Заявка на возврат товаров от клиента» с операцией Возврат от комиссионера. Документ уменьшает количество товаров, находящихся у комиссионера  

Вид цен – вид цен передачи, налогообложение всегда Не облагается (без НДС)

[![3]][3]  

Для отражения возвратов товаров от комиссионера используется документ «Возврат товаров от клиента»    
Вид цен – вид цен передачи, налогообложение всегда Не облагается (без НДС)
