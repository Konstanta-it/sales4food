...
Обязательно к заполнению поле «Статья затрат» (заполняется по цели или вручную из справочника), можно указать аналитику затрат. Это нужно для дальнейшего анализа внутренних потреблений  
