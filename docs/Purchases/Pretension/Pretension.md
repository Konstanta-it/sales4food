...
- Тип претензии - Претензия поставщику;    
...
- Корректировка по соглашению сторон. При нажатии на кнопку Оформлено создается документ Корректировка поступления товаров с видом Корректировка по соглашению сторон. Создание корректировки только для претензии, у которой заполнено Основание на вкладке Основное.  
- Корректировка с исправлением ошибок. При нажатии на кнопку Оформлено создается документ Корректировка поступления товаров с видом Исправление ошибок. Создание корректировки только для претензии, у которой заполнено Основание на вкладке Основное. 
- Возврат товаров. При нажатии на кнопку Оформлено создается документ Возврат товаров от клиента.  
