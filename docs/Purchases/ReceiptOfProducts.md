...
Отражает услуги, которые были выполнены поставщиком. Заполняется номенклатура, её характеристика, количество, упаковка, цены рассчитываются автоматически на основании соглашения с поставщиком.  
Если не стоит галочка Отнести услуги в себестоимость, то для каждой услуги можно указать статью затрат, аналитику, подразделение, направление деятельности. Если настройка включена, то на вкладке **"Факт"** появляется колонка Услуги, и можно перенести стоимость услуг на фактически купленные товары.  
