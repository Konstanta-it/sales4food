...
- Дата
- Основание - заполняется автоматически, поле будет заполнено только в том случае, если возврат товаров был создан на основании документа *"Заявка на возврат товаров от клиента"* или *"Реализация товаров"*
