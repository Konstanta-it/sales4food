...
- Список товарных категорий - если список пустой, то с рампы отгружаются все товарные категории. Если список заполнен товарными категориями, то при подборе рампы для машины, в которую должны быть погружены товары указанных товарных категорий, система подберет рампу с наименьшим порядком содержащую одну из категорий из планов отгрузки
